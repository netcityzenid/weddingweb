...
const UndanganContainer = ({ onOpenInvitation }: UndanganContainerProps) => {
  ...
  const containerVariants = {
    ...
    exit: { y: -1000, opacity: 1, transition: { duration: 4 } }, // Naik ke atas dan menghilang
  };
  ...
  return (
    <div className=" relative z-[1000] max-w-md overflow-hidden mx-auto">
      <motion.div
        className="fixed  overflow-hidden z-[1000] inset-0 flex justify-center items-center bg-[#0a0a0a] px-5 overflow-x-hidden overflow-y-hidden" // Absolute positioning agar container menumpuk di atas
        initial="hidden"
      ...
      >
        ...
        >
          <div className="relative opacity-100  max-w-md mx-auto">
            <div className="bg-gradient-to-t from-black to-transparent h-3/4 absolute bottom-0">
              <Image src={couple} alt="" className=" top-0 opacity-0 z-100 max-w-md mx-auto"></Image>
            </div>
            <Image src={couple} alt="" className=" opacity-100 max-w-md mx-auto"></Image>
          </div>
        </motion.div>
        <motion.div
